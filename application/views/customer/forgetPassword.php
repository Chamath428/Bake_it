...
<body>
	...
	<section>
		...
		<div class="detail-section">
			...
			<form method="post" action="<?php echo BASEURL.'/loginController/submitForgetPassword'; ?>">
				<div class="input-box">
				<span>Mobile Number</span>
				<input type="text" name="phonenumber-readonly" readonly placeholder="Your Mobile Number" value="<?php if(isset($data['phonenumber']))echo $data['phonenumber']; ?>" onkeypress="javascript:return isNumber(event)">
				<input type="hidden" name="phonenumber" value="<?php if(isset($data['phonenumber']))echo $data['phonenumber']; ?>">
				</div>
