  ...
  <div id="body" class="container-1">
    <div class="container-2">
      ...
      <div id="popup-2" class="popup-container">
        <div class="mid-box">
        <i onclick="closePopup2()" class="fas fa-times"></i>
        ...
        <div class="basic-details">
          <table>
            ...
            foreach ($data[0] as $key => $basicOrderDetails) { ?>
              ...
              <tr>
                <td>Order Status</td>
                <td><?php if ($basicOrderDetails['order_status'] == 1) {
                      echo "Order Accepted";
                    }
                    if ($basicOrderDetails['order_status'] == 2) {
                      echo "Order Accepted";
                    } elseif ($basicOrderDetails['order_status'] == 3) {
              ...
              <tr>
                ...
                <td> <?php if ($basicOrderDetails['payment_type'] == 1) {
                        echo "Cash Payment";
                      } else {
                        echo "Card Payment";
                      } ?></td>
              ...
              <?php if ($basicOrderDetails['receiving_method'] == 2) { ?>
                <tr>
                  ...
                  <td><?php if (isset($basicOrderDetails['delivery_person_id'])) {
                        echo $basicOrderDetails['delivery_person_id'];
                      } else {
                        echo "Not Assigned";
                      } ?></td>
                  <!-- <td><a href="">Dilantha Malagamuwa</a></td> -->
              ...
              <tr>
                ...
                <td>
                  <div class="cell">
                    ...
                    <div>
                      <p><?php echo $orderItemDetails['item_name']; ?></p>
                    </div>
                  </div>
                </td>
