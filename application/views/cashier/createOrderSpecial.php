                    ...
                    <div class="payment">
                            ...
                            <div class="text-box">
                                ...
                                <h3>Contact Details</h3>
                                    ...
                                      <input type="phonenumber" id="Phone-number" onkeypress="javascript:return isNumber(event)" name="Phone-number" value="">
                                </div>
                            </div>
                    ...
                    <div class="total-container">
                        <table class="balance">
                            <tr>
                                ...
                                <td><input type="number" readonly name="total-amount" id="total-amount" value="0"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="balance" id="balance" readonly  value="0" onkeypress="javascript:return isNumber(event)"></td>
                            </tr>
                        </table>
                    </div>
                </div>
