...
<body class="bgg">
    ...
    <div class="modal-body">
      ...
      <form method="post" action="<?php echo BASEURL."/cashierOrderListController/completePickupFromShopSpecial/".$data[1]['order_id'] ?>">
            <table class="balance">
                            <tr>
                            ...
                            <tr>
                                <th><span>Advanced Payment(RS:)</span></th>
                                <td><input type="number" readonly name="advanced-amount" id="advanced-amount" value="<?php echo $data[1]['paid_amount']?>"></td>
                            </tr>

                            <tr>
                                <th><span>Amount Left(RS:)</span></th>
                                <td><input type="number" readonly name="left-amount" id="left-amount" value="<?php echo $data[1]['total_amount']-$data[1]['paid_amount']?>"></td>
                            </tr>

                            <tr>
                                <th><span>Amount Paid(RS:)</span></th>
                                <td><input type="number" required name="paid-amount"  id="paid-amount" oninput="calc3()" onkeypress="javascript:return isNumber(event)" value=""></td>
                            </tr>
                            <tr>
                                <th><span>Balance Due(RS:)</span></th>
                                <td><input type="number" name="balance" id="balance" readonly  value="0" onkeypress="javascript:return isNumber(event)"></td>
                            </tr>
                    </table>
